...
class TestAbs(unittest.TestCase):
    ...
    def formCombined(self, link):
        ...
        # Отправляем заполненную формузн
        ...
        self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "Should be all forms")

    def test_registration1(self):
        link = "http://suninjuly.github.io/registration1.html"
        self.formCombined(link)
